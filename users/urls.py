...
urlpatterns = [
    ...
    path('user/editar/<int:pk>/', views.UserUpdateView.as_view(), name='editar_usuarios'),
    ...
    path('produto/editar/<int:pk>/', views.ProdutoUpdateView.as_view(), name='editar_produto'),
    ...
    path('ceo/categoria/editar/<int:pk>/', views.CeoCategoriaUpdateView.as_view(), name='editar_categorias'),
    ...
    path('gerente/vendedor/editar/<int:pk>/', views.GerenteUserUpdateView.as_view(), name='gerente_editar_usuarios'),
    ...
    path('gerente/produto/editar/<int:pk>/', views.GerenteProdutoUpdateView.as_view(), name='gerente_editar_produto'),
    path('gerente/gerenciar_categorias/', views.GerenteCategoriaListView.as_view(), name="gerente_gerenciar_categorias"),
    path('gerente/categoria/editar/<int:pk>/', views.GerenteCategoriaUpdateView.as_view(), name='gerente_editar_categorias'),
    ...
    path('gerente/fornecedor/editar/<int:pk>/', views.GerenteFornecedorUpdateView.as_view(), name='gerente_editar_fornecedor'),
